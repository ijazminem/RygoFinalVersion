jQuery(document).ready(function(){
	...
	*/
	jQuery('#correo_contacto').keyup(function(){
		let info = comprobar_validaciones('#correo_contacto', regexMail, true);
	...
	*/
	jQuery('#correo_contacto_u').keyup(function(){
		let info = comprobar_validaciones('#correo_contacto_u', regexMail, true);
					...
					success: function(data){
						try{
							if(data['success']){
								...
								let tabla_carteras = jQuery('#Tabla_Carteras').DataTable();
                                tabla_carteras.row(id).remove().draw();
							}else{
								Swal.fire({
									icon: 'error',
