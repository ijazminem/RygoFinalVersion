<?php
	...
	*/
	if(
		...
		*/
		$Usuario_Cartera = $Usuario_Cartera_Controller->select_by_id_usuario_id_cartera(strip_tags($_POST['id_usuario']), strip_tags($_POST['id_cartera']));

		if($Usuario_Cartera != null){
			$arrayRequest['success'] = false;
			$arrayRequest['message'] = 'Este usuario ya tiene asignada ésta cartera.';
		}else{
			/**
			 * Crear Modelo
			*/
