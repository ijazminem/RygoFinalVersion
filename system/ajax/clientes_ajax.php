	...
	*/
	if(
		...
		if($Cliente != null){
			...
			$Clientes_Model->set_sexo(strip_tags($_POST['sexo']));
			$Clientes_Model->set_profesion(strip_tags($_POST['profesion']));
			$Clientes_Model->set_fecha_nacimiento(strip_tags($_POST['fecha_nacimiento']));
			$Clientes_Model->set_direccion(strip_tags($_POST['direccion']));
			$Clientes_Model->set_direccion_trabajo(strip_tags($_POST['direccion_trabajo']));
			$Clientes_Model->set_telefono_trabajo(strip_tags($_POST['telefono_trabajo']));
			$Clientes_Model->set_sueldo(strip_tags($_POST['sueldo']));
