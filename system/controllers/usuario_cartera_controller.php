	...
	*/
	class Usuario_Cartera_Controller{
        ...
        */
         ...
         * 
        */
        public function select_all_by_id_usuario_join_carteras($id_usuario){
        	$conexion = new Conexion();
            $cn = $conexion->connect();
            ...
            foreach($query as $data){
				...
				$usuario_cartera['descripcion'] = $data['descripcion'];
				$usuario_cartera['correo_contacto'] = $data['correo_contacto'];
         ...
         * 
        */
        public function select_by_id_usuario_id_cartera($id_usuario, $id_cartera){
        	$conexion = new Conexion();
            $cn = $conexion->connect();

            $query = $cn->prepare("SELECT * FROM " . $this->table_name . " WHERE id_usuario = ? AND id_cartera = ?");
         ...
         * 
        */
        public function select_all_by_id_cartera_join_carteras($id_cartera){
        	$conexion = new Conexion();
            $cn = $conexion->connect();
         ...
         * 
        */
        public function select_by_id_cartera($id_cartera){
        	$conexion = new Conexion();
            $cn = $conexion->connect();
