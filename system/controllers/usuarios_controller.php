	...
	*/
	class Usuarios_Controller{
		...
		*/
         ...
         * 
        */
        public function select_all_by_id_usuario_in_join_usuario_cartera($id_cartera){
			$conexion = new Conexion();
			$cn = $conexion->connect();

			$query = $cn->prepare("SELECT * FROM " . $this->table_name . " WHERE id_usuario IN (SELECT id_usuario FROM usuario_cartera WHERE id_cartera = ?)");
		 ...
		 * 
		*/
		public function select_all_by_id_cartera_join_usuario_cartera($id_cartera){
			$conexion = new Conexion();
			$cn = $conexion->connect();
