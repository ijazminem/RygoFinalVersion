	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				...
				<div>
					<a href="<?php echo PATH; ?>/area/admin/nuevo_contacto/<?php echo $Cliente->get_dui(); ?>">Agregar Contacto</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayContactos) && $arrayContactos != null){
							for($i = 0; $i < sizeof($arrayContactos); $i++){
								...
								echo '<a href="' . PATH . '/area/admin/modificar_contacto/' . $arrayContactos[$i]['id_contacto'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/admin/contacto/' . $arrayContactos[$i]['id_contacto'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
