...
<br><br>
	...
	<section id="Breadcrumbs">
		<div class="breadcrumbs_contet">
			...
			<a href="<?php echo PATH; ?>/area/admin/usuario/<?php echo $Usuario->get_id_usuario(); ?>"><?php echo $Usuario->get_nombre_completo(); ?></a>
			...
			<div class="f_item">
				...
				<select id="id_cartera" class="f_select">
					<?php
						...
						$arrayCarteras = $Carteras_Controller->select_all_by_id_cartera_not_in_join_usuario_cartera($Usuario->get_id_usuario());
