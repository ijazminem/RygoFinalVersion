...
?>
    ...
    <?php
			...
			$error404 = 'No se encontró ningún resultado para éste id de bitacora ' . $_GET['id_bitacora'];

			require_once('404.php');
            
		}
    }else{
				$error404 = 'Este usuario no tiene permisos para modificar esta bitácora.';

				require_once('404.php');
			}
	}else{
		$error404 = 'No se encontró el id de la bitacora.';
