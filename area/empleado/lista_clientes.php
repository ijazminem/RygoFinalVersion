...
?>
	...
	<section id="Title_Page">
		<h1>Lista de Clientes de <?php echo $Cartera->get_nombre_cartera(); ?></h1>
	</section>
					...
					<?php
						...
						if(is_array($arrayClientes) && $arrayClientes != null){
							for($i = 0; $i < sizeof($arrayClientes); $i++){
								...
								echo '<a href="' . PATH . '/area/empleado/modificar_cliente/' . $arrayClientes[$i]['dui'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/empleado/cliente/' . $arrayClientes[$i]['dui'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
...
<?php
				...
				$error404 = 'Este usuario no tiene permisos para ver los deudores de esta cartera.';
