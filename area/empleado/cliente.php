...
?>
	...
	<section class="Content_Info">
		<div class="ci_content">
			...
			<div class="cic_items">
				...
				<div class="cic_item">
					<p><b>Sexo:</b> <?php echo $Cliente->get_sexo(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Profesión:</b> <?php echo $Cliente->get_profesion(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Fecha de nacimiento:</b> <?php echo $Cliente->get_fecha_nacimiento(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Dirección:</b> <?php echo $Cliente->get_direccion(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Dirección de trabajo:</b> <?php echo $Cliente->get_direccion_trabajo(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Teléfono de trabajo:</b> <?php echo $Cliente->get_telefono_trabajo(); ?></p>
				</div>

				<div class="cic_item">
					<p><b>Sueldo:</b> <?php echo $Cliente->get_sueldo(); ?></p>
				</div>
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de Contactos de <?php echo $Cliente->get_nombre_completo(); ?></h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nuevo_contacto/<?php echo $Cliente->get_dui(); ?>">Agregar Contacto</a>
				</div>
			</div>

			<table id="Tabla_Contactos" data-page-length='25'>
				<thead>
					<tr>
						<th>ID</th>
				...
				<tbody>
					<?php
						...
						$arrayContactos = $Contactos_Controller->select_all_by_dui($Cliente->get_dui());

						if(is_array($arrayContactos) && $arrayContactos != null){
							for($i = 0; $i < sizeof($arrayContactos); $i++){
								$Usuario = $Usuarios_Controller->select_by_id($arrayContactos[$i]['id_usuario']);


								echo '<tr id="id_contacto_' . $arrayContactos[$i]['id_contacto'] . '">';
								echo '<td>' . $arrayContactos[$i]['id_contacto'] . '</td>';
								echo '<td>' . $arrayContactos[$i]['nombre_completo'] . '</td>';
								echo '<td>' . $arrayContactos[$i]['direccion'] . '</td>';
								echo '<td>' . $arrayContactos[$i]['telefono'] . '</td>';
								echo '<td>' . $arrayContactos[$i]['parentezco'] . '</td>';
								echo '<td>' . $arrayContactos[$i]['tipo_contacto'] . '</td>';
								...
								echo '<td>' . $arrayContactos[$i]['fecha_registro'] . '</td>';
								echo '<td class="content_opt">';
								echo '<a href="' . PATH . '/area/empleado/modificar_contacto/' . $arrayContactos[$i]['id_contacto'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/empleado/contacto/' . $arrayContactos[$i]['id_contacto'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
								echo '<a class="to_btn to_btn_delete btn_eliminar_contacto to_btn_rr" data-id="' . $arrayContactos[$i]['id_contacto'] . '" title="Eliminar"><i class="fa-regular fa-trash-can"></i></a>';
								echo '</td>';
								echo '</tr>';
							}
						}
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de Deudas de <?php echo $Cliente->get_nombre_completo(); ?></h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nueva_deuda/<?php echo $Cliente->get_dui(); ?>">Agregar Deuda</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayDeudas) && $arrayDeudas != null){
							for($i = 0; $i < sizeof($arrayDeudas); $i++){
								...
								echo '<td>' . $arrayDeudas[$i]['numero_factura'] . '</td>';
								echo '<td>$' . $arrayDeudas[$i]['total_deuda'] . '</td>';
								echo '<td>$' . $arrayDeudas[$i]['valor_cuotas'] . '</td>';
								echo '<td>' . $arrayDeudas[$i]['numero_cuotas'] . '</td>';
								echo '<td>' . $arrayDeudas[$i]['ultima_fecha_pago'] . '</td>';
								...
								echo '<td class="content_opt">';
								echo '<a href="' . PATH . '/area/empleado/modificar_deuda/' . $arrayDeudas[$i]['id_deuda'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/empleado/deuda/' . $arrayDeudas[$i]['id_deuda'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de Gestiones de <?php echo $Cliente->get_nombre_completo(); ?></h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nueva_gestion/<?php echo $Cliente->get_dui(); ?>">Agregar Gestión</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayGestion) && $arrayGestion != null){
							for($i = 0; $i < sizeof($arrayGestion); $i++){
								...
								echo '<td class="content_opt">';
								echo '<a href="' . PATH . '/area/empleado/modificar_gestion/' . $arrayGestion[$i]['id_gestion'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de promesas de pago de <?php echo $Cliente->get_nombre_completo(); ?></h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nueva_promesa_de_pago/<?php echo $Cliente->get_dui(); ?>">Agregar promesa de pago</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayPromesa) && $arrayPromesa != null){
							for($i = 0; $i < sizeof($arrayPromesa); $i++){
								...
								echo '<td class="content_opt">';
								echo '<a href="' . PATH . '/area/empleado/modificar_promesa_de_pago/' . $arrayPromesa[$i]['id_promesa'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de procesos judiciales de <?php echo $Cliente->get_nombre_completo(); ?></h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nuevo_proceso_judicial/<?php echo $Cliente->get_dui(); ?>">Agregar proceso judicial</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayProceso) && $arrayProceso != null){
							for($i = 0; $i < sizeof($arrayProceso); $i++){
								...
								echo '<td class="content_opt">';
								echo '<a href="' . PATH . '/area/empleado/modificar_proceso_judicial/' . $arrayProceso[$i]['id_proceso'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/empleado/proceso_judicial/' . $arrayProceso[$i]['id_proceso'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
...
<?php
				...
				$error404 = 'Este usuario no tiene permisos para ver la información de este deudor en esta cartera.';
