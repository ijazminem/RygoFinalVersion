...
?>
	...
	<title>Actualizar Sub-Estado</title>
	<!-- validaciones -->
...
?>
	...
	<section id="Breadcrumbs">
		<div class="breadcrumbs_contet">
			...
			<a href="<?php echo PATH; ?>/area/empleado/estado/<?php echo $Estado->get_id_estado(); ?>">Estado #<?php echo $Estado->get_id_estado(); ?></a>
...
<?php
				...
				$error404 = 'Este usuario no tiene permisos para modificar este sub-estado.';

				require_once('404.php');
			}
		}else{
			$error404 = 'No se encontró ningún resultado para éste id de sub estado: ' . $_GET['id_sub_estado'];
