...
?>
	...
	<section class="Content_Info">
		<div class="ci_content">
			<h2>Datos del proceso judicial de <?php echo $Cliente->get_nombre_completo(); ?></h2>
    ...
    <section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				...
				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nuevo_archivo/<?php echo $Proceso->get_id_proceso(); ?>">Agregar Archivo</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arrayArchivo) && $arrayArchivo != null){
							for($i = 0; $i < sizeof($arrayArchivo); $i++){
								...
								echo '<a href="' . PATH . '/area/empleado/modificar_archivo/' . $arrayArchivo[$i]['id_archivo'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
    ...
    <section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de bitácoras</h3>
				</div>

				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nueva_bitacora/<?php echo $Proceso->get_id_proceso(); ?>">Agregar Bitácora</a>
				</div>
			</div>
