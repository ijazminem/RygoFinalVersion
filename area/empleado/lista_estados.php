...
?>
	...
	<section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				<div>
					<h3>Lista de Estados de la cartera <?php echo $Cartera->get_nombre_cartera(); ?> </h3>
				</div>
					...
					<?php
						...
						if(is_array($arrayEstados) && $arrayEstados != null){
							for($i = 0; $i < sizeof($arrayEstados); $i++){
								...
								echo '<a href="' . PATH . '/area/empleado/modificar_estado/' . $arrayEstados[$i]['id_estado'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
								echo '<a href="' . PATH . '/area/empleado/estado/' . $arrayEstados[$i]['id_estado'] . '" class="to_btn to_btn_see" title="Ver"><i class="fa-solid fa-circle-info"></i></a>';
...
<?php
				...
				$error404 = 'Este usuario no tiene permisos para ver esta lista de estados de esta cartera.';
