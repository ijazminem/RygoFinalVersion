    ...
    <section class="Content_Table">
		...
		<div class="ct_table">
			<div class="ct_header">
				...
				<div>
					<a href="<?php echo PATH; ?>/area/empleado/nuevo_sub_estado/<?php echo $Estado->get_id_estado(); ?>">Agregar Sub Estado</a>
				</div>
			</div>
					...
					<?php
						...
						if(is_array($arraySubEstados) && $arraySubEstados != null){
							for($i = 0; $i < sizeof($arraySubEstados); $i++){
								...
								echo '<a href="' . PATH . '/area/empleado/modificar_sub_estado/' . $arraySubEstados[$i]['id_sub_estado'] . '" class="to_btn to_btn_edit to_btn_rl" title="Editar"><i class="fa-solid fa-pen-to-square"></i></a>';
...
<?php
			...
			$error404 = 'No se encontró ningún resultado para ésta id de contacto: ' . $_GET['id_estado'];
